...
func newWorkerOnlyConsumer(id uint8, nameWorker string, fn FirstClassFuncOnlyConsumer, workQueue chan ReadMessageDTO, errorChannel chan error, optionalConfiguration OptionalConfiguration) *workerOnlyConsumer {
	return &workerOnlyConsumer{
